...
model = YOLO(r"E:\Road_Traffic_Monitoring-main\Road_Traffic_Monitoring-main\yolov8n.pt")

video = cv2.VideoCapture(r"E:\Road_Traffic_Monitoring-main\Road_Traffic_Monitoring-main\traffic.mp4")
...
up_img = cv2.imread(r"E:\Road_Traffic_Monitoring-main\Road_Traffic_Monitoring-main\up.png", cv2.IMREAD_UNCHANGED)
up_img = cv2.resize(up_img, (50, 50))
down_img = cv2.imread(r"E:\Road_Traffic_Monitoring-main\Road_Traffic_Monitoring-main\down.png", cv2.IMREAD_UNCHANGED)
